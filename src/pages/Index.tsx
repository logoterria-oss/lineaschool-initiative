...
export default function Index() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Персональная работа с ребёнком один на один для максимального эффекта",
      icon: "FileText"
    },
    {
      title: "Групповые занятия",
      description: "Занятия в малых группах для социализации и взаимного обучения",
      icon: "BookOpen"
    },
    {
