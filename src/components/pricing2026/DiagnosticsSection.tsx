      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <Card className="relative p-6 border-2 border-green-500 shadow-lg flex flex-col">
          ...
          <div className="text-center mb-4 mt-2">
            ...
            <p className="text-gray-600 text-sm mb-2">Полное обследование чтения и письма, механизмов нарушения, консультация и индивидуальный план коррекции дислексии/дисграфии/дизорфографии</p>
