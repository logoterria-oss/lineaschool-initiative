    ...
    <>
      ...
      <div className="md:hidden fixed bottom-4 right-4 z-50 flex flex-col gap-2 items-end">
        <Button 
          ...
          variant="outline" 
          size="sm"
          className="bg-white/95 backdrop-blur-sm border-green-500 text-green-600 hover:bg-green-50 shadow-lg h-9 w-9 p-0 min-w-0 flex-shrink-0"
        >
        ...
        <Button 
          ...
          size="sm"
          className="bg-green-500 hover:bg-green-600 text-white shadow-lg h-9 px-3 text-xs font-medium animate-button-pulse min-w-0"
        >
