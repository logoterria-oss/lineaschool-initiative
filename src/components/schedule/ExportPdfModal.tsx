        ...
        <div className="overflow-y-auto flex-1 px-5 pb-5 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              ...
              {isOnce
                ? 'Неделя считается от выбранного дня (по умолчанию — сегодня) плюс 6 дней. Показываем всё, что свободно в этот период, без проверки будущих недель. Сегодняшние занятия, которые уже начались или начнутся менее чем через 30 минут, не предлагаем.'
