        ...
        <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 md:p-8">
              <h4 className="text-lg font-bold text-center mb-4 md:mb-6">Карта активности мозга</h4>
              ...
              {/* Легенда */}
              <div className="mt-4 md:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs md:text-sm">
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-pink-300 rounded flex-shrink-0 mr-3"></div>
                  <span>Лобная доля</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-yellow-400 rounded flex-shrink-0 mr-3"></div>
                  <span>Теменная доля</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-green-500 rounded flex-shrink-0 mr-3"></div>
                  <span>Височная доля</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-red-500 rounded flex-shrink-0 mr-3"></div>
                  <span>Затылочная доля</span>
                </div>
                <div className="flex items-center sm:col-span-2 sm:justify-center">
                  <div className="w-4 h-4 bg-cyan-500 rounded flex-shrink-0 mr-3"></div>
