        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="relative overflow-hidden border-0 shadow-xl bg-gradient-to-br from-green-500 to-green-600 text-white">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4 h-16 flex items-center">Логопед: индивидуальные занятия</h3>
              <div className="text-green-100 font-semibold mb-6">1 раз в неделю</div>
          ...
          <Card className="relative overflow-hidden border-0 shadow-xl bg-gradient-to-br from-purple-500 to-purple-600 text-white">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4 h-16 flex items-center">Нейропсихолог: индивидуальные занятия</h3>
              <div className="text-purple-100 font-semibold mb-6">1 раз в неделю</div>
          ...
          <Card className="relative overflow-hidden border-0 shadow-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4 h-16 flex items-center">Групповые занятия</h3>
              <div className="text-blue-100 font-semibold mb-6">2 раза в неделю</div>
