    ...
    <section className="relative py-4 sm:py-6 md:py-8 lg:py-12 bg-gradient-to-bl from-green-50 via-white to-green-50/30 overflow-hidden" translate="no">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="px-0">
            <div className="inline-flex items-center border-2 border-blue-500 bg-gradient-to-br from-green-50 via-white to-green-50/30 text-blue-600 px-2 py-1 xs:px-3 xs:py-1.5 sm:px-4 sm:py-2 rounded-full text-[10px] xs:text-xs sm:text-sm font-semibold mb-2 xs:mb-3 sm:mb-4 md:mb-6">🎓 Для детей 8-18 лет</div>
            <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-3 xs:mb-4 sm:mb-6 md:mb-8 leading-tight bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(34,197,94,0.15)]">
            ...
            <div className="mb-3 xs:mb-4 sm:mb-6 md:mb-8 w-full">
              <Button 
                size="sm" 
                className="bg-gradient-to-r from-green-500 to-blue-500 text-white hover:from-green-600 hover:to-blue-600 text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-lg px-2 xs:px-3 sm:px-4 md:px-6 lg:px-8 py-2 xs:py-2.5 sm:py-3 md:py-4 w-full transition-all duration-300 shadow-lg h-auto min-h-[44px]"
            ...
            <div className="grid grid-cols-3 gap-1.5 xs:gap-2 sm:gap-3 md:gap-4 w-full items-start">
              <div className="text-center px-0.5">
                <div className="text-base xs:text-lg sm:text-xl md:text-2xl font-bold text-green-600 leading-tight">200+</div>
                <div className="text-[9px] xs:text-[10px] sm:text-xs text-gray-600 leading-tight mt-0.5">довольных семей</div>
              </div>
              <div className="text-center px-0.5">
                <div className="text-base xs:text-lg sm:text-xl md:text-2xl font-bold text-green-600 leading-tight whitespace-nowrap">от 970₽</div>
                <div className="text-[9px] xs:text-[10px] sm:text-xs text-gray-600 leading-tight mt-0.5">за урок</div>
              </div>
              <div className="text-center px-0.5">
                <div className="text-base xs:text-lg sm:text-xl md:text-2xl font-bold text-green-600 leading-tight">98%</div>
                <div className="text-[9px] xs:text-[10px] sm:text-xs text-gray-600 leading-tight mt-0.5">успешных кейсов</div>
              </div>
            </div>
          </div>
