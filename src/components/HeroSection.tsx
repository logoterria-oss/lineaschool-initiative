      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="px-2 sm:px-0">
            <div className="inline-flex items-center border-2 border-green-500 text-green-600 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6 hover:bg-green-500 hover:text-white transition-all duration-300 bg-blue-600">🎓 Для детей 8-18 лет</div>
