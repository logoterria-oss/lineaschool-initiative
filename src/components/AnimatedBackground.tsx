...
export default function AnimatedBackground() {
  ...
  // Фиксированный массив завитушек (не генерируется каждый рендер)
  const swirls = [
    ...
    { x: 18, y: 40, size: 37, rotation: 165, speed: 0.17, type: 0 },
    { x: 72, y: 80, size: 30, rotation: 90, speed: -0.13, type: 1 },
  ];
