...
export const educationRows: { label: string; value: React.ReactNode }[] = [
  {
    ...
    value: (
      <>
        Адаптированная дополнительная общеразвивающая программа «Коррекция
        нарушений процессов чтения и письма (дислексия, дисграфия,
        дизорфография)».{" "}
        <DocLink href="https://disk.yandex.ru/i/sqNtf00DUxsaNw" />
      </>
    ),
  },
  {
  ...
  { label: "Нормативный срок обучения", value: "От 1 года до 3 лет" },
  {
    label:
