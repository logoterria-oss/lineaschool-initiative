...
const specialists = [
  ...
  },
  {
    ...
    role: "Логопед-нейропсихолог",
    description: "Эксперт по нейропсихологической диагностике, специализируется на работе с подростками и взрослыми",
    avatar: "https://cdn.poehali.dev/files/39e06528-df6e-46ad-a501-a6a4de01c57e.jpg"
  },
  {
    name: "Мила Яровець",
    role: "Логопед",
    description: "Ведущий специалист по игровым методикам коррекции, автор развивающих программ для дошкольников и младших школьников",
    avatar: "https://cdn.poehali.dev/files/b6aa3ad4-6e9c-4fe1-8741-3009f1cf33c2.jpg"
  },
  {
    name: "Дарья Еремина",
    role: "Логопед", 
    description: "Специалист по подготовке к ОГЭ и ЕГЭ, эксперт по преодолению школьных трудностей у подростков",
